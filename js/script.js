...
const config = {
    serverInfo: {
        ...
        serverIp: "play.helixversemc.com", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1270520177737596938" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    All skins for original players are generate automaticaly. If you want to add skins to warez players, yout must add url for skin to skinUrlOrPathToFile
        {
            inGameName: "Shardino",  <--- In-Game name
            rank: "Founder",  <-- rank
    ...
    */
    ...
    atGroupsDefaultColors: {
        founder: "rgba(255, 124, 124, 0.5)",
        developers: "rgba(78, 219, 59, 0.5)",
        admin: "rgba(230, 177, 5, 0.5)",
        mod: "rgba(5, 133, 230, 0.5)",
    },
    adminTeamPage: {
        founder: [
            {
                inGameName: "Samuelep123410",
                rank: "Founder",
                skinUrlOrPathToFile: "",
